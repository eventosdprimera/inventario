...
let fotosOriginalesEquipo = []; // Para almacenar las fotos originales del equipo
...
// ✅ Cargar fotos originales del equipo desde la tabla equipos
...
// ==========================================
// ✅ CARGAR FOTOS ORIGINALES DEL EQUIPO (desde tabla equipos)
// ==========================================
...
try {
// Buscar el equipo en la tabla equipos (aunque esté averiado, sus fotos deberían estar en el respaldo)
...
// Si no hay fotos en equipos, intentar buscar en el historial o en la avería misma
if (fotosOriginalesEquipo.length === 0 && averiaSeleccionadaReint) {
fotosOriginalesEquipo = [
...
// ==========================================
// ✅ REINTEGRAR EQUIPO (CORREGIDO CON FOTOS ORIGINALES)
// ==========================================
...
foto_url: fotosOriginalesEquipo[0] || null,
foto2_url: fotosOriginalesEquipo[1] || null,
foto3_url: fotosOriginalesEquipo[2] || null,
foto4_url: fotosOriginalesEquipo[3] || null,
